...
export const geoApiOptions = {
	method: 'GET',
	headers: {
		'x-rapidapi-key': (process.env.REACT_APP_GEO_API as string),
...
// Unsplash API For Extarnal Random Images
export const REACT_APP_UNSPLASH_API_BASE_URL = (process.env.REACT_APP_UNSPLASH_API_BASE_URL as string);